= SCM Version Plugin
:latestRevision: 3.4.0
:toc:

NOTE: Version 3.4 of this plugin will only work with JDK 8, Gradle 4.4 and later. Version 3.3 can be used for Gradle 4.4 and previous version of Gradle 4.
...
the hash string will attached to the version instead of SNAPSHOTS.
