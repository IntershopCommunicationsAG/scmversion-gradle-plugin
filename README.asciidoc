...
|*svntest*        | Root URL of the test project        |
|*svntestuser*    | User name of Subversion test user   | Must be specified with project property *`svntestuser`*
|*svntestuserpwd* | Password for Subversion test user   | Must be specified with project property *`svntestuserpwd`*
|===
...
|*gittest*        | URL of the test project      |
|*gittestuser*    | User name of Git test user   | Must be specified with project property *`gittestuser`*
|*gittestuserpwd* | Password for Git test user   | Must be specified with project property *`gittestuserpwd`*
|===
